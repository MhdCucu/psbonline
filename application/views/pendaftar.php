		...
		<div class="row">
			<div class="span3 theportfolio all-group cat1-group">
				...
				<div class="detailholder gray-boxed">
					<h4 class="showbiz-title txt-left nobottommargin"><a href="#" class="black">Data Pendaftar</a></h4>
			...
			<div class="span9">
				<article>
					<h6>Berikut adalah informasi mengenai data pendaftar Penerimaan Siswa Baru di SMAN 1 Cisarua periode 2013/2014</h6>
					<div class="divide10"></div>

					<table border="0" width="100%" id="daftar">
					    <tr class="blue">
					    	<th>No. </th>
